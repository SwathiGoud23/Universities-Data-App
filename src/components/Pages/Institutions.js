...
// import { fetchInstitutions } from '../../actions/institutionsActions';
// import './style.scss'
...
//   const [errorMessages, setErrorMessages] = useState<Partial<Institution>>({
//     name: '',
//     address: '',
//     country: '',
//     region: '',
...
//     // Fetch institutions data from the API
//     axios
//       .get<Institution[]>('http://localhost:3000/institutions')
//       .then(response => {
//         setInstitutions(response.data);
//         setIsLoading(false); // Data fetching is complete
//       })
...
//     axios
//       .post<Institution>('http://localhost:3000/institutions', formData)
//       .then(response => {
//         setShowModal(false);
//         setInstitutions([...institutions, response.data]);
//         setSuccessMessage('Institution name successfully added!');
...
//   // Function to reset error messages when the user interacts with the input fields
//   const handleInputChange = (fieldName: keyof Institution) => (event: ChangeEvent<HTMLInputElement>) => {
//     setErrorMessages(prevErrorMessages => ({
//       ...prevErrorMessages,
//       [fieldName]: '',
//     }));
